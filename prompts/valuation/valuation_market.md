...
- `source`가 `global_news`인 해외 뉴스는 산업 시장성이 아니라 글로벌 사업성 근거로만 사용한다.
...
목적:
수집된 글로벌 해외 뉴스 근거를 바탕으로 평가대상 기술의 핵심 기능 또는 직접 적용 분야에서 글로벌 시장 관심과 해외 적용 흐름이 확인되는지 평가한다. 해외특허의 경우에는 대상 특허의 해당 국가를 제외한 해외 시장에서의 진출 및 활용 흐름을 본다.
...
- 글로벌 뉴스 근거가 부족하면 해외 시장 확장 가능성을 단정하지 않는다.
- 글로벌 뉴스 근거 부족을 시장성 감점 사유처럼 길게 설명하지 않는다.
- 글로벌 뉴스에서 확인된 해외 뉴스 근거가 있을 때만 글로벌 사업성의 보조 긍정 근거로 설명한다.
...
점수 후보:
20:
글로벌 뉴스 근거에서 평가대상 기술의 핵심 기능 또는 직접 적용 분야와 관련된 해외 도입, 제품화, 서비스 확산, 고객 수요, 규제·산업 변화가 3건 이상 확인됨

10:
글로벌 뉴스 근거에서 평가대상 기술의 핵심 기능 또는 직접 적용 분야와 관련된 해외 도입, 제품화, 서비스 확산, 고객 수요, 규제·산업 변화가 1~2건 확인되거나, 인접 적용 분야의 해외 확산 근거가 일부 확인됨

0:
글로벌 뉴스 근거가 없거나, 넓은 AI/자동화/디지털 전환 흐름만 있고 평가대상 기술의 핵심 기능 또는 직접 적용 분야와 연결되지 않음
...
- `subscores.global_business.rationale`에는 글로벌 해외 뉴스 근거에서 확인된 글로벌 시장 관심과 해외 적용 흐름을 요약한다.
