...
점수 후보:
20:
GNews 근거에서 평가대상 기술의 핵심 기능 또는 직접 적용 분야와 관련된 해외 도입, 제품화, 서비스 확산, 고객 수요, 규제·산업 변화가 3건 이상 확인됨

10:
GNews 근거에서 평가대상 기술의 핵심 기능 또는 직접 적용 분야와 관련된 해외 도입, 제품화, 서비스 확산, 고객 수요, 규제·산업 변화가 1~2건 확인되거나, 인접 적용 분야의 해외 확산 근거가 일부 확인됨

0:
GNews 근거가 없거나, 넓은 AI/자동화/디지털 전환 흐름만 있고 평가대상 기술의 핵심 기능 또는 직접 적용 분야와 연결되지 않음
