...
## 검증 기준
이 단계는 외부 검색으로 수집한 근거(Naver 뉴스, GNews, 산업 리포트 RAG, SK AX 공식/계열)가 시장성·사업 연계성·요약을 뒷받침할 만큼 충분한지 판단합니다. 다음을 확인하세요.
...
2. 글로벌 근거가 있는가?
   - 해외 뉴스(GNews)의 글로벌 시장 관심·해외 적용 신호
...
## 평가 범위 주의
- query_rewriting은 외부 검색 근거(Naver News, GNews, 산업 리포트 RAG, SK AX)만 재수집합니다.
